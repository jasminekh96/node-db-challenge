...
Relational databases is the software that manages the storage, CRUD operations etc. SQL is the language that we use to interact to the relational databse. 
